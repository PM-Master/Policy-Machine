    ...
    return function(e) {
        ...
        (function(e) {
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.shallowEqualKeys = t.buildFormData = t.sorters = t.btoa = t.parseSearch = t.getSampleSchema = t.validateParam = t.validateString = t.validateBoolean = t.validateFile = t.validateInteger = t.validateNumber = t.propChecker = t.errorLog = t.memoize = t.isImmutable = void 0;
            var x = n(26),
                w = r(x),
                j = n(13),
                C = r(j),
                ...
                if (a && (o || r)) {
                    ...
                    if ("string" === a) {
                        ...
                        y = e.getIn(["items", "type"]), r.forEach(function(e, t) {
                            var r = void 0;
                            "number" === y ? r = ee(e) : "integer" === y ? r = te(e) : "string" === y && (r = oe(e)), r && n.push({
                                index: t,
                                error: r
                            })
                        })
            ...
            return function(t, n) {
                return function(r) {
                    if (n && n.specSelectors && n.specSelectors.specJson) {
                        return o(n.specSelectors.specJson()) ? c.default.createElement(e, (0, l.default)({}, r, n, {
                            Ori: t
        ...
        var a = n(8),
            ...
            d = t.sampleFromSchema = function e(t) {
                ...
                if ("object" === o) {
                    ...
                    if (!0 === l) h.additionalProp1 = {};
                        ...
                        for (var v = (0, a.objectify)(l), y = e(v, n), g = 1; g < 4; g++) h["additionalProp" + g] = y;
                    return h
                }
            ...
            p = (t.inferSchema = function(e) {
                ...
                if ("object" === o) {
                    ...
                    h[E] = [], s = s || {};
                    for (var j in w)
                        if ((!w[j].readOnly || c) && (!w[j].writeOnly || d))
                            if (w[j].xml = w[j].xml || {}, w[j].xml.attribute) {
                                var C = Array.isArray(w[j].enum) && w[j].enum[0],
                                    A = w[j].example,
                                    O = w[j].default;
        ...
        var w = n(513),
            ...
            L = t.CLEAR_REQUEST = "spec_clear_request",
            F = t.ClEAR_VALIDATE_PARAMS = "spec_clear_validate_param",
            B = t.UPDATE_OPERATION_VALUE = "spec_update_operation_value",
            J = t.UPDATE_RESOLVED = "spec_update_resolved",
            W = t.SET_SCHEME = "set_scheme",
            V = (t.parseToJson = function(e) {
                return function(t) {
                    var n = t.specActions,
                        r = t.specSelectors,
                        o = t.errActions,
                ...
                return function(t) {
                    var n = t.fn,
                        ...
                        l = e.operation,
                        s = a(),
                        c = s.requestInterceptor,
                        f = s.responseInterceptor,
                        d = l.toJS();
                ...
                return (0, m.default)(t, e), (0, f.default)(t, [{
                    ...
                    value: function() {
                        var e = this.props,
                            ...
                            c = t("PrimitiveModel"),
                            f = r && r.get("$$ref"),
                            d = f && this.getModelName(f),
                            p = void 0,
                            h = void 0,
                            m = n.isOAS3() && r.get("deprecated");
                        switch (r && (r.get("type") || r.get("properties")) ? p = r : f && (p = this.getRefSchema(d)), h = p && p.get("type"), !h && p && p.get("properties") && (h = "object"), h) {
                            ...
                            case "array":
                                return y.default.createElement(s, (0, a.default)({
                                    className: "array"
                                }, this.props, {
                                    schema: p,
                                    name: d || u,
                            ...
                            case "boolean":
                            default:
                                return y.default.createElement(c, (0, a.default)({}, this.props, {
                                    getComponent: t,
                                    schema: p,
                                    name: d || u,
                                    deprecated: m,
        ...
        function o(e) {
            var t = e.source,
                n = a(t);
            return t && n && "undefined" !== n ? i.default.createElement("div", {
                className: "markdown"
            ...
            c = function(e) {
                ...
                var o = t.map(function(t, n) {
                    return i.default.createElement("div", {
                        key: n
                    }, i.default.createElement("h2", null, n), t.map(function(t, o) {
                        return i.default.createElement("div", {
                            key: o
                        }, t.map(function(t, u) {
                            return i.default.createElement(r, (0, a.default)({
                                operation: t,
                                key: u,
                                method: u,
            ...
            x = function(e) {
                ...
                return (0, v.default)(t, e), (0, d.default)(t, [{
                    ...
                    value: function() {
                        ...
                        }, g.default.createElement("b", null, g.default.createElement("code", null, n)), s ? g.default.createElement(a, {
                            source: s
                        }) : null), g.default.createElement("pre", null, "Operation `", i, "`", g.default.createElement("br", null), g.default.createElement("br", null), "Parameters ", o(0, (0, u.default)(l, null, 2)) || "{}", g.default.createElement("br", null)))
                    }
                }]), t
            }(y.Component);
        x.propTypes = {
        ...
        var o = n(0),
            ...
            d = function(e) {
                var t = e.requestBody,
                    ...
                    d = t && t.get("content") || new c.OrderedMap;
                o = o || d.keySeq().first();
                var p = d.get(o),
                    h = (0, f.getSampleSchema)(p.get("schema").toJS(), o, {
                        includeWriteOnly: !0
                    });
                return a.default.createElement("div", null, s && a.default.createElement(u, {
                        source: s
                    ...
                    expandDepth: 1,
                    schema: p.get("schema"),
                    example: a.default.createElement(l, {
                        value: h
                    })
                }))
            };
        ...
        t.default = {
            ...
            model: p.default,
            onlineValidatorBadge: f.default,
            TryItOutButton: m.default
        }
    }, function(e, t, n) {
        "use strict";
                ...
                return (0, m.default)(t, e), (0, f.default)(t, [{
                    ...
                    value: function() {
                        ...
                        return n && (t.push("deprecated"), r = y.default.createElement("span", {
                            ...
                            className: t.join(" ")
                        }, r, y.default.createElement(E.Model, (0, a.default)({}, this.props, {
                            depth: 1,
            ...
            w = function(e) {
                ...
                return (0, p.default)(t, e), (0, s.default)(t, [{
                    ...
                    value: function() {
                        ...
                        return m.default.createElement("div", {
                        ...
                        }, m.default.createElement("span", null, "Parameters"))), f.get("callbacks") ? m.default.createElement("div", {
                            onClick: function() {
                            ...
                            className: "opblock-title"
                        }, m.default.createElement("span", null, "Callbacks"))) : null), a ? m.default.createElement(p, {
                            enabled: u,
                            onCancelClick: r,
                            onTryoutClick: n
                        }) : null), this.state.parametersVisible ? m.default.createElement("div", {
                            className: "parameters-container"
                        }, o.count() ? m.default.createElement("div", {
                        ...
                        }, m.default.createElement("p", null, "No parameters"))) : "", this.state.callbackVisible ? m.default.createElement("div", {
                            className: "callbacks-container opblock-description-wrapper"
                        }, m.default.createElement(v, {
                            callbacks: (0, g.Map)(f.get("callbacks"))
                        })) : "", b() && E && this.state.parametersVisible && m.default.createElement("div", {
                                className: "opblock-section"
                            }, m.default.createElement("div", {
                                className: "opblock-section-header"
                            }, m.default.createElement("h4", {
                                className: "opblock-title parameter__name " + (E.get("required") && "required")
                            }, "Request body"), m.default.createElement("label", null, m.default.createElement(h, {
                                value: this.state.requestBodyContentType,
                                contentTypes: E.get("content").keySeq(),
                                onChange: function(t) {
                                    return e.setState({
                                        requestBodyContentType: t
                                    })
                                },
        ...
        w.propTypes = {
            parameters: E.default.list.isRequired,
        ...
        t.default = (0, a.OAS3ComponentWrapFactory)(function(e) {
            var t = e.Ori;
            return o.default.createElement("span", null, o.default.createElement(t, e), o.default.createElement("small", {
                style: {
                    backgroundColor: "#89bf04"
                }
            }, o.default.createElement("pre", {
                className: "version"
            }, "OAS3")))
        })
    }, function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
            value: !0
        }), t.isSwagger2 = t.isOAS3 = t.schemes = t.produces = t.consumes = t.basePath = t.host = t.definitions = void 0;
        var o = n(44),
            a = n(7),
            u = n(24),
            i = function(e) {
            ...
            s = r(l),
            c = (0, o.createSelector)(i, function(e) {
                ...
                return (0, p.default)(t, e), (0, s.default)(t, [{
                    ...
                    value: function() {
                        var e = this.props,
                            ...
                            n = e.layoutSelectors,
                            r = n.whatMode(b),
                            o = r === S ? m.default.createElement("noscript", null) : t[0],
        ...
        e.exports = function(e, t, n, m, v, y, g) {
            ...
            if (r && !g || !p && !w && j[d] || u(j, d, A), l[t] = A, l[S] = h, v)
                if (_ = {
                        values: x ? A : E("values"),
                        keys: y ? A : E("keys"),
        ...
        var o = n(26),
            ...
            E = {
                ...
                GIT_DIRTY: !1,
                HOSTNAME: "WM-5020",
                BUILD_TIME: "Sat, 19 Aug 2017 01:36:52 GMT"
            },
            S = E.GIT_DIRTY,
            x = E.GIT_COMMIT,
            w = E.PACKAGE_VERSION,
        ...
        e.exports = function(e) {
            ...
            var t = {
                ...
                r = e.domNode;
            delete e.domNode;
            var o = (0, f.default)({}, t, e, n),
                u = (0, f.default)({}, o.store, {
                    system: {
                        configs: o.configs
                    },
                    plugins: o.presets,
                ...
                return (0, y.default)(t, e), (0, p.default)(t, [{
                    ...
                    value: function() {
                        var e = this.props,
                            ...
                            f = t("ModelCollapse"),
                            d = t("Model"),
                            p = s && _.default.createElement("span", {
                        ...
                        return _.default.createElement("span", {
                            className: "model"
                        }, _.default.createElement(f, {
                            title: p,
                            collapsed: r > o,
                            collapsedContent: "[...]"
                        }, "[", _.default.createElement("span", null, _.default.createElement(d, (0, i.default)({}, this.props, {
                            schema: l,
                            required: !1,
                            depth: r + 1
                        }))), "]", c.size ? _.default.createElement("span", null, c.entrySeq().map(function(e) {
                ...
                return (0, m.default)(t, e), (0, f.default)(t, [{
                    ...
                    value: function() {
                        ...
                        return y.default.createElement("div", {
                            ...
                            className: "scope-def"
                        }, y.default.createElement("p", null, "Scopes are used to grant an application different levels of access1 to data on behalf of the end user. Each API may declare one or more scopes."), y.default.createElement("p", null, "API requires the following scopes. Select which ones you want to grant to Swagger UI.")), n.filter(function(e) {
                            return "oauth2" === e.get("type")
                        }).map(function(e, t) {
                            return y.default.createElement("div", {
                                key: t
                ...
                return (0, p.default)(t, e), (0, s.default)(t, [{
                    ...
                    value: function() {
                        ...
                        return t.specStr() ? m.default.createElement("div", {
                            ...
                            schemes: f,
                            specActions: n
                        }) : null, s ? m.default.createElement(v, null) : null)) : null, null === S || !1 === S ? null : m.default.createElement("div", {
            ...
            return (0, m.default)(t, e), (0, f.default)(t, [{
                ...
                value: function() {
                    ...
                    return y.default.createElement("div", null, c && y.default.createElement(E, {
                        ...
                        headers: p,
                        getComponent: n
                    }) : null, C ? y.default.createElement(S, {
                        headers: j
                    }) : null, o && g ? y.default.createElement(x, {
                        duration: g
                    }) : null)))))
                }
            }]), t
                ...
                return (0, p.default)(t, e), (0, s.default)(t, [{
                    ...
                    value: function() {
                        ...
                        return m.default.createElement("div", null, m.default.createElement("ul", {
                            ...
                            "data-name": "model",
                            onClick: this.activeTab
                        }, "Model")) : null), m.default.createElement("div", null, (a || "example" === this.state.activeTab) && o, !a && "model" === this.state.activeTab && m.default.createElement(u, {
                                schema: r,
                                getComponent: t,
                                specSelectors: n,
                                expandDepth: 1
                ...
                return (0, _.default)(t, e), (0, m.default)(t, [{
                    ...
                    value: function() {
                        var e = this.props,
                            ...
                            j = E.default.createElement("span", null, E.default.createElement("span", null, "{"), "...", E.default.createElement("span", null, "}"), r ? E.default.createElement(x, {
                                name: n
                            }) : ""),
                            C = f.isOAS3() ? t.get("anyOf") : null,
                        ...
                        return E.default.createElement("span", {
                            ...
                            }, E.default.createElement(b, (0, a.default)({
                                key: "object-" + n + "-" + r + "_" + l
                            }, c, {
                                required: s,
                                getComponent: o,
                        ...
                        }).toArray() : null, m && m.size ? E.default.createElement("tr", null, E.default.createElement("td", null, "< * >:"), E.default.createElement("td", null, E.default.createElement(b, (0, a.default)({}, c, {
                            required: !1,
                            getComponent: o,
                            schema: m,
                            depth: u + 1
                        })))) : null, C ? E.default.createElement("tr", null, E.default.createElement("td", null, "anyOf ->"), E.default.createElement("td", null, C.map(function(e, t) {
                            return E.default.createElement("div", {
                                key: t
                            }, E.default.createElement(b, (0, a.default)({}, c, {
                                required: !1,
                                getComponent: o,
                                schema: e,
                                depth: u + 1
                ...
                return (0, p.default)(t, e), (0, s.default)(t, [{
                    ...
                    value: function() {
                        var e = this.props,
                            ...
                            k = a.get("__originalOperationId"),
                            P = v.operationScheme(r, o),
                            T = p("responses"),
                            M = p("parameters"),
                            q = p("execute"),
                            N = p("clear"),
                        ...
                        var V = this.state.tryItOutEnabled,
                            ...
                            Y = [r, o];
                        return m.default.createElement("div", {
                            className: x ? "opblock opblock-deprecated" : H ? "opblock opblock-" + o + " is-open" : "opblock opblock-" + o,
                            id: t.join("-")
                        }, m.default.createElement("div", {
                            ...
                            href: J ? "#/" + t[1] + "/" + t[2] : ""
                        }, m.default.createElement("span", null, r)), m.default.createElement(D, {
                            path: n
                        })), u ? m.default.createElement("div", {
                            className: "opblock-summary-description"
                        }, E) : null, c && k ? m.default.createElement("span", {
                            className: "opblock-summary-operation-id"
                        }, k) : null, C && C.count() ? m.default.createElement(I, {
                            authActions: y,
                            security: C,
                            authSelectors: _
                        }) : null), m.default.createElement(U, {
                            isOpened: H
                        }, m.default.createElement("div", {
                            className: "opblock-body"
                        }, x && m.default.createElement("h4", {
                                className: "opblock-title_normal"
                            }, " Warning: Deprecated"), S && m.default.createElement("div", {
                                className: "opblock-description-wrapper"
                            }, m.default.createElement("div", {
                        ...
                        return w && !0 !== w && (f = f.filter(function(e, t) {
                            ...
                            return y.default.createElement("div", {
                                ...
                                var p = e.get("path", ""),
                                    ...
                                    S = ["operations", f, b],
                                    x = t.allowTryItOutFor(e.get("path"), e.get("method")),
                ...
                return (0, p.default)(t, e), (0, s.default)(t, [{
                    ...
                    value: function() {
                        var e = this.props,
                            ...
                            f = r("ParamBody"),
                            d = t.get("in"),
                            p = "body" !== d ? null : m.default.createElement(f, {
                                getComponent: r,
                                fn: a,
                                param: t,
                        ...
                        }, t.get("name"), S ? m.default.createElement("span", {
                            style: {
                                color: "red"
                            }
                        }, " *") : null), m.default.createElement("div", {
                            className: "parameter__type"
                        }, g, " ", x && "[" + x + "]"), m.default.createElement("div", {
                            className: "parameter__deprecated"
                        }, s && s() && t.get("deprecated") ? "deprecated" : null), m.default.createElement("div", {
                            className: "parameter__in"
                        }, "(", t.get("in"), ")")), m.default.createElement("td", {
                            className: "col parameters-col_description"
                        }, m.default.createElement(v, {
                            source: t.get("description")
                        }), b && !E && m.default.createElement("div", null, "Error: your browser does not support FormData"), p || !o ? null : m.default.createElement(c, {
                            fn: a,
                            getComponent: r,
                            value: j,
                            required: S,
                ...
                return (0, p.default)(t, e), (0, s.default)(t, [{
                    ...
                    value: function() {
                        ...
                        return m.default.createElement("div", {
                            ...
                            className: "col col_header parameters-col_description"
                        }, "Description"))), m.default.createElement("tbody", null, S(o, function(t) {
                    ...
                    value: function() {
                        ...
                        return y.default.createElement("span", {
                            ...
                            className: "prop"
                                ...
                                className: (1 === o && "model-title") + " prop-name"
                            }, r), y.default.createElement("span", {
                            className: "prop-type"
                        }, u), i && y.default.createElement("span", {
                                className: "prop-format"
                            }, "($", i, ")"), f.size ? f.entrySeq().map(function(e) {
                            var t = (0, a.default)(e, 2),
                                n = t[0],
                                r = t[1];
                            return y.default.createElement("span", {
                        ...
                        }) : null, c ? y.default.createElement(d, {
                            source: c
                        ...
                        }).toArray()) : null, s && y.default.createElement(p, {
                                value: s,
                                getComponent: n
                            })))
                    }
                ...
                return (0, p.default)(t, e), (0, s.default)(t, [{
                    ...
                    value: function() {
                        ...
                        if (d()) {
                            ...
                            e = C ? (0, x.getSampleSchema)(C.toJS(), this.state.responseContentType, {
                                includeReadOnly: !0
                            }) : null, t = C ? f(C.toJS()) : null
                        } else t = f(a.toJS()), e = t ? (0, x.getSampleSchema)(t, c, {
                            includeReadOnly: !0,
                            includeWriteOnly: !0
                        }) : null;
                        var A = w(e, h, y);
                        return _.default.createElement("tr", {
                            ...
                            contentTypes: a.get("content") ? a.get("content").keySeq() : (0, S.Seq)(),
                            onChange: function(e) {
                                return n.setState({
                        ...
                        }) : null, A ? _.default.createElement(g, {
                            getComponent: l,
                            specSelectors: s,
                            schema: (0, S.fromJS)(t),
                            example: A
                        }) : null, p ? _.default.createElement(v, {
                            headers: p
                        }) : null), s.isOAS3() ? _.default.createElement("td", {
                            className: "col response-col_links"
                        }, m ? m.toSeq().map(function(e, t) {
                            return _.default.createElement(E, {
                                key: t,
                                name: t,
                                link: e,
                                getComponent: l
                ...
                return (0, m.default)(t, e), (0, f.default)(t, [{
                    ...
                    value: function() {
                        ...
                        return y.default.createElement("div", {
                            ...
                            className: "opblock-section-header"
                        }, y.default.createElement("h4", null, "Responses"), l.isOAS3() ? null : y.default.createElement("label", null, y.default.createElement("span", null, "Response content type"), y.default.createElement(p, {
                            value: c,
                        ...
                        }, o ? y.default.createElement("div", null, y.default.createElement(h, {
                            request: r,
                            response: o,
                            getComponent: u,
                            getConfigs: i,
                            ...
                            className: "col col_header response-col_description"
                        }, "Description"), l.isOAS3() ? y.default.createElement("td", {
                            className: "col col_header response-col_links"
                        }, "Links") : null)), y.default.createElement("tbody", null, n.entrySeq().map(function(e) {
                            var t = (0, a.default)(e, 2),
                                n = t[0],
                                r = t[1],
                                i = o && o.get("status") == n ? "response_current" : "";
        ...
        var o = n(0),
            ...
            l = function(e) {
                var t = e.version;
                return a.default.createElement("small", null, a.default.createElement("pre", {
                    className: "version"
                }, " ", t, " "))
            };
        l.propTypes = {
        ...
        function r(e) {
            ...
            var b = [s.get("authorizationUrl"), h.join("&")].join("?"),
                E = void 0;
            E = "implicit" === p ? n.preAuthorizeImplicit : l.useBasicAuthenticationWithAccessCodeGrant ? n.authorizeAccessCodeWithBasicAuthentication : n.authorizeAccessCodeWithFormParams, a.default.swaggerUIRedirectOauth2 = {
                auth: t,
                state: y,
                redirectUrl: m,
                callback: E,
        ...
        function o(e, t, n) {
            var r = [(0, T.systemThunkMiddleware)(n)],
                o = P.default.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ || E.compose;
            ...
            q = function() {
                function e() {
                    ...
                    (0, g.default)(this, e), (0, j.default)(this, {
                        ...
                        boundSystem: {},
                        toolbox: {}
                    }, t), this.getSystem = this._getSystem.bind(this), this.store = c(M, (0, S.fromJS)(this.state), this.getSystem), this.buildSystem(!1), this.register(this.plugins)
                }
        ...
        var r, o, a, u, i = n(64),
            ...
            T = function(e) {
                y.call(l, function() {
                    var t, n, r, o = e._v,
                        a = M(e);
                    if (a && (t = b(function() {
                            j ? x.emit("unhandledRejection", o, e) : (n = l.onunhandledrejection) ? n({
                                promise: e,
                                reason: o
            ...
            q = function(e) {
                y.call(l, function() {
                    var t;
                    j ? x.emit("rejectionHandled", e) : (t = l.onrejectionhandled) && t({
                            promise: e,
                            reason: e._v
                        })
                })
        ...
        O || (w = function(e) {
            ...
            Promise: w
        }), n(66)(w, "Promise"), n(325)("Promise"), u = n(9).Promise, f(f.S + f.F * !O, "Promise", {
            reject: function(e) {
                var t = A(this);
        ...
        var r = n(14),
            ...
            Y = function(e, t, n) {
                return e === L && Y(z, t, n), _(e), t = E(t, !0), _(n), o(U, t) ? (n.enumerable ? (o(e, q) && e[q][t] && (e[q][t] = !1), n = x(n, {
                    enumerable: S(0, !1)
                })) : (o(e, q) || R(e, q, S(1, {})), e[q][t] = !0), W(e, t, n)) : R(e, t, n)
            },
            $ = function(e, t) {
                _(e);
        ...
        r(r.P + r.R, "Promise", {
                ...
                var t = u(this, o.Promise || a.Promise),
                    n = "function" == typeof e;
        ...
        (function(e) {
            ...
            function q(e, t, n) {
                ...
                if (e + t > n) throw new RangeError("Trying to access1 beyond buffer length")
            }
        ...
        var r, o = n(34),
            ...
            j = function() {
                ...
                var t = !1;
                try {
                    if (t = S && S.resolve && w(), m(e, S), e.prototype = o.create(S.prototype, {
                            constructor: {
                                value: e
                            }
                        }), e.resolve(5).then(function() {}) instanceof e || (t = !1), t && n(103)) {
                        var r = !1;
        ...
        j || (S = function(e) {
            ...
            Promise: S
        }), n(104)(S, "Promise"), n(362)("Promise"), r = n(50).Promise, s(s.S + s.F * !j, "Promise", {
            reject: function(e) {
                var t = new R(this);
                return (0, t.reject)(e), t.promise
            }
        ...
        var a = {
            "./not-of-type.js": 139,
            "./parameter-oneof.js": 140,
            "./strip-instance.js": 141
        };
        r.keys = function() {
            return Object.keys(a)
